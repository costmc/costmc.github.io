...
export default class Track extends React.Component {
	...
	render() {
		...
		return (
			<a className="track d-flex align-items-center mb-3" onClick={ this.handlePlayPauseClick }> 
    ...
    render() {
        ...
        return(
            <div className="track__progress progress">
                <div className="progress__bar bg-primary" role="progressbar" aria-valuenow="25" aria-valuemin="0"
